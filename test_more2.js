...
let widgetInputRAW = args.widgetParameter || "12397|4|results=720|0|100";

try {
	widgetInputRAW.toString();
} catch(e) {
	throw new Error("Please long press the widget and add a parameter. Eg: 12397|4|results=720|0|100");
}
...
const thingSpeakSettings = {  
  ...
  // min Line parameters
  minParams: inputArr[3],

  // max Line parameters
  maxParams: inputArr[4],
...
class LineChart {
  ...
  _calculatePath() {
    ...
    if (thingSpeakSettings.minParams == a)  {
      ...
      let mminValue = thingSpeakSettings.minParams;
    }
